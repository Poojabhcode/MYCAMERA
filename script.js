...
captureBtn.addEventListener("click", function () {
  ...
  //zoom  stretched kra canvas ko
  tool.scale(currZoom, currZoom);
  //w api top left pr leaye origin
  tool.translate(-canvas.width / 2, -canvas.height / 2);
...
promiseToUseCamera
  .then(function (mediaStream) {
    //  mediaStream ek object hai jisme continously camera and mic ka input ara hai and wo input fir using objects video me dalra hu
